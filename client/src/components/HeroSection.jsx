...
const HeroSection = () => {
  return (
    <div className="flex justify-between items-center px-6 sm:px-10 md:px-14 lg:px-18  min-h-[90vh] bg-gradient-to-r from-rose-100 to-teal-100">
      <div className="w-[40vw]">
        <div>
          <h1 className="font-bold font-display text-xl sm:text-2xl md:text-4xl lg:text-5xl leading-16 my-5">
            <span className="text-primary">Elevate</span> your <span className="text-secondary">FITNESS GAME</span>
          </h1>
